...
void setup()
{
  ...
  Serial2.begin(MASTER_LINK_BAUD, SERIAL_8N1, MASTER_LINK_RX_PIN, MASTER_LINK_TX_PIN); // Master 링크 (포고핀)
...
void loop()
{
  ...
  Serial2.print(gz);
  Serial2.print(",");
  Serial2.print(irValue);
  Serial2.print(",");
  Serial2.println(beatDetected ? 1 : 0);
